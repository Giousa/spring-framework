...
public abstract class AbstractBeanFactory extends FactoryBeanRegistrySupport implements ConfigurableBeanFactory {
	...
	protected <T> T doGetBean(
		...
		if (sharedInstance != null && args == null) {
			...
			//注意：这里获取的实例是原始状态，需要重新对bean进行实例化
			...
			//依赖检查，倘若是单例情况，需要解决循环依赖问题。
			//倘若isPrototypeCurrentlyInCreation=true，需要抛出异常，提醒
			...
			//父类工厂不为空，且当前配置的xml不包含beanName，需要去父类加载
			...
			//如果不是做类型检查，而是真正创建bean的时候，需要记录创建信息
			if (!typeCheckOnly) {
